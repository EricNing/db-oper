...
# res = oracle1._selectALL('select * from gy_business_base_info')
...
# print mysql._checkRecord('busiinfo',{'busiInfoID': '3302123330010'})

print mysql.get_sql('busiinfo', None, {'busiInfoID': '3302123330010'})
...
# data = oracle._selectOne('select * from books_bookinfo where id=1')
# oracle._insertOne('books_02', data)
#
# res = oracle._selectALL('select * from books_02')
# for i in res:
#     print i
# print '----------------------------------------------------'
#
# data1 = oracle._selectOne('select id from books_bookinfo where id=1')
# print data1
# # sql = 'delete from books_02 where id=:id'
# # oracle._cursor.execute(sql, data1)
# # oracle._commit()
#
# oracle._delete('books_02', ['id'], data1)
...
# res = oracle._getALL('select * from books_01')
# for i in res:
#     print i
oracle1._close()
oracle._close()
